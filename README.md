...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fwpkmgw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fwpkmgw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Anayaali2019/container-fwpkmgw.git
cd container-fwpkmgw
```
...
```
docker attach container-fwpkmgw
```
